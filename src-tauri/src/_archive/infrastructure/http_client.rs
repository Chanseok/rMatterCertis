// ARCHIVED: legacy infrastructure/http_client.rs (archived on 2025-08-23)
// This file is kept for reference only. The active HttpClient is the unified client in
// `infrastructure/simple_http_client.rs` and re-exported by `infrastructure.rs`.
// Guarded out of compilation to avoid analyzer confusion.
#![cfg(any())]
#![allow(dead_code)]
...
use super::super::infrastructure::simple_http_client as unified;
