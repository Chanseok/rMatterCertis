...
impl ParseContext {
    ...
    #[must_use]
    pub const fn with_expected_products(mut self, count: u32) -> Self {
...
impl DetailParseContext {
    ...
    #[must_use]
    pub const fn new(url: String, base_url: String) -> Self {
        Self {
            url,
            base_url,
            source_page_id: None,
    ...
    #[must_use]
    pub const fn with_source(mut self, page_id: u32, index: u32) -> Self {
