...
mod tests {
    ...
    #[test]
    fn parser_creation() {
        let parser = ListPageParser::new("https://csa-iot.org".to_string(), 50);
    ...
    fn url_normalization() {
        ...
        assert_eq!(
            result.unwrap(),
            "https://csa-iot.org/csa_product/wifi-plug-27"
        );
    }
    ...
    async fn task_processing() {
        ...
        if let Ok(TaskResult::Success {
            output: TaskOutput::ProductUrls(urls),
            ..
        }) = result
        {
