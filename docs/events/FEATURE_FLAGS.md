...
- MC_FEATURE_EMIT_PAGETASK_LEGACY (default: true)
  - Emit AppEvent::PageTask* alongside PageLifecycle for backward compatibility.
  - Set to 0 after FE moves to PageLifecycle to reduce event noise.

Notes
- All flags are additive/migration aids; defaults preserve current behavior.
